...
Sweeping the consensus genes from top 20 to top 200 (exact counts verified: top20=190, top50=1225, top100=4950, top200=19900 pairs) confirms that **PKM + ADAM22** consistently achieves the highest overall Pair Score due to its low Spearman redundancy ($r = 0.063$) and stable ensemble thresholds.
