...
\title{以無偏差轉錄體剖析進行胰臟腫瘤微環境之邏輯閘生物感測器的數據驅動設計}
\author{施貞蓉$^1$、宿淂芳$^1$、廖軒佑$^2$、林家誼$^2$}
\affil{$^1$國立臺灣大學 生命科學系\\$^2$國立臺灣大學 生化科技學系}
\date{2026年5月}
